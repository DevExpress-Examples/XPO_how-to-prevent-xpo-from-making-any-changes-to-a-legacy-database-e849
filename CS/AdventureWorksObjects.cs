namespace AdventureWorks {
    ...
    public class OrderHeader : ReadOnlyObject {
    ...
    public class Customer : ReadOnlyObject {
    ...
    public class SalesPerson : ReadOnlyObject {
    ...
    public class Territory : ReadOnlyObject {
    ...
    public class StateProvince : ReadOnlyObject {
    ...
    public class Address : ReadOnlyObject {
